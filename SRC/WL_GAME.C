...
// calculate newx
//
		x = (FixedMul(gx,viewcos) - FixedMul(gy,viewsin)) >> TILESHIFT;

//
// calculate newy
//
		y = (FixedMul(gy,viewcos) + FixedMul(gx,viewsin)) >> TILESHIFT;
...
//
		...
		FizzleFade((long)vbuf,(long)vdisp+screenofs,viewwidth,viewheight,70,false);
